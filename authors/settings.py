...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'localhost',
    'ah-backend-dojo.herokuapp.com',
    'ah-backend-dojo-dev.herokuapp.com'
]
...
SOCIAL_AUTH_FACEBOOK_KEY = '280866512794030'  # App ID
SOCIAL_AUTH_FACEBOOK_SECRET = 'aeb7bee9b520f4644027248779e1fd93'  # App Secret
